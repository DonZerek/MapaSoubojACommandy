...
public class Main {
	...
	/**
	 * Lze použít pro otestování vašeho kódu s využitím pøiloženého souboru s mapou svìta
	 * Pokud píšete vlastní tøídy mùže testovací kód vypadat úplnì jinak
	 * @param args vstupní prametry pro spuštìní z pøíkazové øádky
	 */
